...
$hero_subtitle =
    'Connecting Communities brings reliable Internet and essential services together, making them easier for communities to access in one connected local platform.';
$hero_description =
    'Enabled by TrAC, the model starts with strong connectivity, creating the foundation for financial tools, education, clean water, agriculture, nutrition, and other services that support everyday life.';
...
$hero_image_alt =
    is_array($hero_image) && !empty($hero_image['alt'])
        ? $hero_image['alt']
    ...
    <img
        src="<?php echo esc_url(
            get_template_directory_uri() .
                '/src/imgs/communities/hero-icons.png',
        ); ?>"
