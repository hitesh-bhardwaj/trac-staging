...
<section class="communities-hero relative w-full min-h-screen bg-white pt-[12vw] pb-[6.25vw] px-[5.208vw] md:pt-32 md:pb-16 md:px-[4vw] sm:pt-24 sm:pb-12 sm:px-[6vw]" data-section="communities-hero">
    <div class="hero-content text-center mb-[5.208vw] md:mb-16 sm:mb-12 space-y-[2vw]">
        <h1 class="hero-title font-heading hero-title-line leading-[1.08] tracking-[-0.04vw] text-[#111] max-w-[71.51vw] mx-auto md:text-6xl md:leading-[1.2] sm:text-4xl" data-animate="fade-up">
            <?php echo esc_html($hero_title); ?>
        </h1>

        <?php if ($hero_subtitle): ?>
            <p class="hero-subtitle-1 !text-center font-body font-normal text-text-body w-[70%] max-w-[51.406vw] mx-auto md:max-w-full" data-animate="fade-up" data-delay="0.1">
