...
<section class="open-positions-section relative overflow-hidden bg-white pb-[7vw] md:py-20 sm:py-16" data-section="open-positions" id="open-positions">
    <div class="w-full px-[5.21vw] md:px-[4vw] sm:px-[6vw]">
        <div class="mx-auto">
            ...
            <!-- Heading -->
            <h2 class="font-heading text-66 font-normal leading-[1.12] tracking-[-0.01em] text-[#111] text-center mb-[4vw] md:text-5xl md:mb-12 sm:text-4xl sm:mb-10" data-heading-anim>
                Open Positions
            </h2>
