...
$cta_title = get_field('cta_title') ?: 'Ready to Strengthen Your
Network Infrastructure?';
$cta_subtitle =
    get_field('cta_subtitle') ?:
    "If your organisation requires secure, scalable, and resilient connectivity,
TrAC is ready to support your next phase of growth.";
...
<section class="cta-section relative bg-[#eef3fc] overflow-hidden" data-section="cta">
    ...
    <div class="cta-container relative z-[1] w-full px-[5.21vw] py-[10.417vw] md:px-[4vw] md:py-32 sm:px-[6vw] sm:py-24 ">
        <div class="cta-content text-center max-w-[51vw] mx-auto mt-[5vw] md:max-w-full space-y-[15vw]">
            <div>
                ...
                <p class="cta-subtitle font-body text-[1.25vw] leading-[1.5] text-[#1e1e1e] mb-[4.167vw] md:text-lg md:mb-10 sm:text-base sm:mb-8 w-[85%] mx-auto " data-animate="fade-up" data-delay="0.1">
