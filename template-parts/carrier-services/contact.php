...
<section id="get-in-touch" class="carrier-contact relative bg-white pt-[7vw] md:py-20 sm:py-16" data-section="carrier-contact">
    <div class="w-full px-[5vw] md:px-[7vw]">
        <div class="max-w-[104rem] mx-auto grid grid-cols-[1fr_1fr] gap-[6vw] items-start md:grid-cols-1 md:gap-12">
            <div class="pt-[0.5vw] md:pt-0">
                ...
                <p class="font-body text-24 leading-[1.45] text-text-body mb-[0.5vw] md:mb-10 sm:mb-8 max-w-[30vw] md:max-w-full" data-para-anim data-delay="0.2">
            ...
            <div class="flex justify-end md:justify-start" data-animate="fade-up" data-delay="0.25">
                ...
                data-delay="0.2" class="contact-form-card w-full max-w-[42.7vw] md:max-w-full bg-white rounded-[2vw] md:rounded-3xl border-[1.5px] border-brand-primary p-[4.1vw_2.6vw] md:p-12 sm:p-6">
