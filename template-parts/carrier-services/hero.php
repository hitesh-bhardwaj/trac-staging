            ...
            <div class="hero-text w-full max-w-[80rem] text-center">
                <div>
                    ...
                    >
                        ...
                        <span class="block hero-title-line">
                            <?php echo esc_html(
                                get_field('hero_title_line_2') ?: 'Infrastructure for ISPs and Carriers'
                            ); ?>
                        </span>
                    </h1>
                ...
                <div class="enterprise-hero-images w-full mx-auto mt-0 md:mt-10 sm:mt-8 flex items-end justify-center h-full gap-[1.25vw]">
                    ...
                    >
                        <img
                            src="<?php echo esc_url(
                                get_template_directory_uri() . '/src/imgs/carrier-services/hero-img-1.png'
                            ); ?>"
                    ...
                    >
                        <img
                            src="<?php echo esc_url(
                                get_template_directory_uri() . '/src/imgs/carrier-services/hero-img-2.png'
                            ); ?>"
                    ...
                    >
                        <img
                            src="<?php echo esc_url(
                                get_template_directory_uri() . '/src/imgs/carrier-services/hero-img-3.png'
                            ); ?>"
