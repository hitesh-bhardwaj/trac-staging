...
$container_classes =
    $container_classes !== ''
        ? $container_classes
        : 'hero-container w-full px-[5vw]  pb-[5vw] relative z-[10] md:px-[7vw] md:pt-16 sm:pt-[14vw]';
            ...
            <div class="<?php echo esc_attr($grid_classes); ?>">
                ...
                <?php elseif ($media_src !== ''): ?>
                    <div
                        ...
                        data-hero-delay="0.2"
                    >
                        <div class="h-[40vw] w-full overflow-hidden rounded-[1.3vw] md:h-[60vw] md:rounded-2xl sm:h-[70vw]">
                            <img
