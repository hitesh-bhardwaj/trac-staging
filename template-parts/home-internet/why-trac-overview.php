...
<section class="home-internet-why relative overflow-hidden bg-brand-tint py-[8vw] md:py-20 sm:py-16" data-section="home-internet-why">
    <div class="relative z-[1] w-full px-[9vw] md:px-[7vw]">
        <div class="max-w-[92rem] mx-auto">
            ...
            <h2 class="font-heading text-66 font-normal leading-[1.3] tracking-[0.01em] text-text-primary mb-[1.6vw] md:mb-6 text-left sm:w-[70%]" data-heading-anim>
    ...
    $index * 0.1,
            ...
            <div class="grid grid-cols-3 gap-[3.5vw] md:grid-cols-2 md:gap-6 sm:grid-cols-1 sm:gap-4 items-stretch">
                <?php foreach ($cards as $i => $c): ?>
                    <div class="rounded-[1vw] md:rounded-2xl bg-brand-tertiary p-[1.8vw] md:p-8 sm:p-4 sm:py-6 flex flex-col items-start justify-between h-[12vw] gap-[1.4vw] md:gap-6 md:h-[25vw] sm:h-[43vw] " data-animate="fade-up" data-delay="<?php echo esc_attr(
                        0.06 * $i,
                    ); ?>">
                        <img
                            ...
                            loading="lazy"
                        >
                        <p class="font-body text-white text-24 leading-[1.45] w-full">
