        ...
        <div class="max-w-[92rem] mx-auto">
            ...
            <div class="grid grid-cols-3 gap-[3.5vw] md:grid-cols-2 md:gap-6 sm:grid-cols-1 sm:gap-4 items-stretch">
                <?php foreach ($cards as $i => $c): ?>
                    <div class="rounded-[1.042vw] md:rounded-2xl bg-[color:var(--color-brand-tertiary)] p-[1.8vw] py-[2.2vw] md:p-8 sm:p-6 flex flex-col items-start justify-between h-[13vw] gap-[1.4vw] md:gap-6" data-animate="fade-up" data-delay="<?php echo esc_attr(
                        0.06 * $i,
                    ); ?>">
                        <img
                            src="<?php echo esc_url($c['icon']); ?>"
                            alt=""
                            class="w-[3vw] h-[3vw] md:w-10 md:h-10 sm:w-9 sm:h-9 object-contain"
                            loading="lazy"
                        >
