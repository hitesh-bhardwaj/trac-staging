...
<section class="cta-section relative bg-[#2F5FA0] overflow-hidden" data-section="cta">
    <div class="cta-bg-pattern absolute inset-0 top-[-23%] left-[15%] w-[70%] h-full <?php echo esc_attr(
        $pattern_top_class,
    ); ?>">
        <svg width="1796" height="670" viewBox="0 0 1796 670" fill="none" xmlns="http://www.w3.org/2000/svg" data-cta-svg class="w-full h-full">
            <path d="M897.253 0.433594L897.753 669.434" stroke="#00285B"/>
            <path d="M1795.73 0.433594C1795.73 0.433594 1480.02 188.66 1307.73 346.434C1181.94 461.627 1013.73 669.434 1013.73 669.434" stroke="#00285B"/>
            <path d="M156.253 0.433594C156.253 0.433594 459.317 171.52 600.753 346.434C692.225 459.557 802.34 669.434 802.34 669.434" stroke="#00285B"/>
            <path d="M1639.73 0.433594C1639.73 0.433594 1336.67 171.52 1195.23 346.434C1103.76 459.557 993.644 669.434 993.644 669.434" stroke="#00285B"/>
            <path d="M312.253 0.433594C312.253 0.433594 588.919 172.632 695.253 346.434C765.457 461.18 822.427 669.434 822.427 669.434" stroke="#00285B"/>
            <path d="M1483.73 0.433594C1483.73 0.433594 1207.07 172.632 1100.73 346.434C1030.53 461.18 973.558 669.434 973.558 669.434" stroke="#00285B"/>
            <path d="M468.253 0.433594C468.253 0.433594 691.966 180.748 765.753 346.434C817.782 463.261 842.514 669.434 842.514 669.434" stroke="#00285B"/>
            <path d="M1327.73 0.433594C1327.73 0.433594 1104.02 180.748 1030.23 346.434C978.203 463.261 953.471 669.434 953.471 669.434" stroke="#00285B"/>
            <path d="M624.253 0.433594C624.253 0.433594 778.46 208.825 825.753 346.434C869.573 473.939 862.601 669.434 862.601 669.434" stroke="#00285B"/>
            <path d="M1171.73 0.433594C1171.73 0.433594 1017.52 208.825 970.231 346.434C926.411 473.939 933.384 669.434 933.384 669.434" stroke="#00285B"/>
            <path d="M780.253 0.433594C780.253 0.433594 843.514 209.91 863.753 346.434C882.333 471.762 882.688 669.434 882.688 669.434" stroke="#00285B"/>
            <path d="M1015.73 0.433594C1015.73 0.433594 952.471 209.91 932.231 346.434C913.652 471.762 913.297 669.434 913.297 669.434" stroke="#00285B"/>
            <path d="M0.25293 0.433594C0.25293 0.433594 315.961 188.66 488.253 346.434C614.046 461.627 782.253 669.434 782.253 669.434" stroke="#00285B"/>
            
            <defs>
                <linearGradient id="paint0_linear_329_19266" x1="1388.75" y1="224" x2="1432.49" y2="178.5" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#E86224"/>
    ...
    <div class="cta-container relative z-[10] w-full px-[5.21vw] py-[7vw] md:px-[4vw] md:py-32 sm:px-[6vw] sm:py-24 ">
        <div class="cta-content text-center max-w-[51vw] mx-auto mt-[5vw] md:max-w-full space-y-[15vw]">
            <div>
                <h2 class="cta-title font-heading text-[3.438vw] leading-[1.12] tracking-[0.01em] text-white mb-[1.563vw] md:text-4xl md:mb-4 sm:text-3xl sm:mb-3" data-heading-anim>
                ...
                <div class="cta-button-wrapper mt-[5vw] <?php echo esc_attr(
