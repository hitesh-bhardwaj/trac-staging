...
<section class="hero-new relative w-full min-h-screen bg-white" data-section="hero-new" data-hero-static>
    <div class="hero-new-container w-full px-[5.21vw] pt-[13vw] pb-[7.031vw] md:px-[4vw] md:pt-[160px] md:pb-16 sm:px-[6vw] sm:pt-[140px] sm:pb-12">
        ...
        <div class="hero-text-content relative z-[10] text-center mb-[5.208vw] md:mb-16 sm:mb-12">
            <!-- Main Title -->
            <h1 class="hero-main-title font-heading text-[3.958vw] leading-[5vw] tracking-[0.04vw] text-[#111] mb-[3.125vw] max-w-[71.51vw] mx-auto md:text-5xl md:leading-[1.2] md:mb-8 sm:text-4xl sm:mb-6" data-hero-reveal data-heading-anim data-base-delay="0.05">
                <span class="block hero-title-line"><?php echo esc_html($hero_title); ?></span>
            </h1>

            <!-- Subtitle -->
            <p class="hero-subtitle font-heading text-[1.875vw] tracking-[0.019vw] text-[#111] mb-[5vw] md:text-3xl md:mb-8 sm:text-2xl sm:mb-6" data-hero-reveal data-hero-delay="0.10" data-para-anim>
                <?php echo esc_html($hero_subtitle); ?>
            </p>

            <!-- Description -->
            <p class="hero-description font-body text-[1.25vw] leading-[2.083vw] text-[#1e1e1e] max-w-[46.927vw] mx-auto md:text-xl md:leading-[1.6] md:max-w-full sm:text-lg sm:leading-[1.5]" data-hero-reveal data-hero-delay="0.18" data-para-anim>
                <?php echo esc_html($hero_description); ?>
            </p>
        </div>

        <!-- Hero Image -->
        <div class="hero-image-container relative z-[10]" data-hero-reveal data-hero-delay="0.28">
