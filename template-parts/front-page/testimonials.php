...
<section class="testimonials-section relative overflow-hidden sm:py-[15%]" data-section="testimonials">
    <div class="testimonials-container w-full flex flex-col items-end px-[5vw] pb-[6.25vw] md:py-16 sm:px-[7vw] sm:py-12 md:items-center sm:gap-[7vw]">
...
?>
                        <div class="testimonial-card rounded-[1.563vw] bg-brand-primary p-[3.125vw] md:rounded-3xl md:p-8 sm:rounded-[2vw] sm:p-6">
                            <?php if ($quote): ?>
                                <p class="font-body font-normal mb-[2.083vw] text-24 leading-[1.6] text-white md:mb-6 md:text-lg sm:mb-5 sm:text-base">
