        ...
        <div data-animate="fade-up" class="counter flex w-full justify-center" data-counter-section>
            <div class="counter-grid grid w-full max-w-[72vw] grid-cols-3 gap-[3.5vw] md:max-w-full md:grid-cols-1 md:gap-10 md:w-full">
                <?php foreach ($who_we_are_stats as $index => $stat): ?>
                    <article
                        class="counter-item relative flex flex-col items-center px-[1.523vw] text-center md:mt-10 md:flex-row md:justify-between md:px-0 <?php echo $index <
                        count($who_we_are_stats) - 1
                            ? ' has-divider after:absolute after:right-[-1.823vw] after:top-1/2 after:h-[12.292vw] after:w-[1.5px] after:-translate-y-1/2 after:bg-[#10417F] md:after:bottom-[-4vw] md:after:left-0 md:after:right-0 md:after:top-auto md:after:h-px md:after:w-full md:after:translate-y-0'
                            : ''; ?>"
                    >
                        ...
                        <p data-para-anim class="whitespace-nowrap font-body text-[1.15vw] leading-[1] text-text-body lg:max-w-none md:whitespace-normal md:text-[24px] md:text-right md:max-w-[45%] sm:text-[4vw]">
