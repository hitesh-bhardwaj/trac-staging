...
<section class="relative py-[9vw] bg-brand-tertiary h-auto overflow-visible lg:h-[260vh] md:h-auto md:py-[15%]" data-section="what-we-do" data-what-we-do-slider>
    <div class="what-we-do-shell w-full ">
        <div class="mb-[5vw]  px-[5vw] flex items-center justify-between md:mb-10 sm:px-[6vw]">
            <div data-animate="fade-up" class="what-we-do-header flex items-center gap-[0.8vw] md:gap-3">
            ...
            <div data-animate="fade-up" class="what-we-do-nav flex fadeup items-center gap-[0.6vw] md:hidden overflow-visible" aria-label="<?php esc_attr_e(
                'What we do navigation',
                'trac',
            ); ?>">
                <button type="button" class="what-we-do-nav-btn flex h-[2.7vw] min-h-11 w-[4.6vw] min-w-[3.9vw] items-center justify-center rounded-full border border-white/60 bg-transparent text-white transition-all duration-300 hover:bg-brand-secondary hover:text-white hover:border-brand-secondary disabled:opacity-40 disabled:hover:bg-transparent disabled:hover:text-white" data-what-we-do-prev aria-label="<?php esc_attr_e(
                    'Previous',
                    'trac',
                ); ?>">
        ...
        <div class="what-we-do-viewport overflow-x-auto overflow-y-hidden [scroll-snap-type:x_mandatory] [-webkit-overflow-scrolling:touch] scroll-smooth [scrollbar-width:none] [&::-webkit-scrollbar]:hidden pl-[30vw] pr-[5vw] [scroll-padding-left:30vw] md:pl-[8vw] md:pr-[8vw] md:[scroll-padding-left:8vw] sm:pl-0 sm:pr-0" data-what-we-do-viewport>
            ...
            <div class=" flex gap-[1.6vw] w-max [will-change:transform] ml-0 sm:ml-10 md:gap-6 sm:gap-4" data-what-we-do-track data-animate="fade-up">
                <?php foreach ($what_we_do_cards as $card): ?>
                    <article class="what-we-do-card flex h-[30vw] w-[25vw] flex-shrink-0 flex-col rounded-[1.5vw] border border-white/60 bg-white px-[2vw] py-[2.2vw] shadow-[0_24px_80px_rgba(16,65,127,0.08)] [scroll-snap-align:center] [will-change:transform,opacity] md:h-[55vw] md:w-[78vw] md:rounded-[28px] md:px-8 md:py-8 sm:w-[78vw] sm:rounded-[24px] sm:px-6 sm:py-10 sm:h-auto" >
                        <div class="mb-[5.2vw] text-brand-primary md:mb-10 sm:mb-[14vw]">
                            <img
                        ...
                        <h2 class="mb-[1.8vw] font-heading w-[80%] text-36 font-normal leading-[1.3] tracking-[-0.02em] text-text-primary md:mb-5 md:text-[34px] sm:text-[28px]">
                            <?php echo trac_esc_html($card['title']); ?>
                        </h2>

                        <p class="font-body text-[1.1vw] leading-[1.45] text-text-body md:text-[22px] sm:text-[17px]">
        ...
        <div data-animate="fade-up" class="hidden md:flex items-center justify-center gap-[1vw] mt-10 sm:gap-3 sm:mt-8">
