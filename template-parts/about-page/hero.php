...
<section class="hero relative min-h-screen bg-[#0B1F3A]! overflow-hidden" data-section="hero" data-hero-static>
    <div class="hero-container w-full px-[5.21vw] pt-[12vw] pb-[5.21vw] relative z-[10] md:px-[4vw] md:pt-[120px] sm:px-[8vw] sm:pt-[100px]">
        <div class="hero-grid flex items-start justify-between gap-[10vw] md:flex-col md:gap-8 ">
            <div class="hero-text w-[45%] md:w-full md:max-w-full relative z-[10]">
                <h1
                ...
                <p
                    class="hero-subtitle font-body font-medium text-white mb-[3.125vw] md:w-full md:max-w-full md:mb-8 sm:mb-6 md:text-center"
                    data-hero-reveal
            ...
            <div class="hero-media w-[55%] md:w-full">
                <div class="h-[40vw] w-full overflow-hidden rounded-[1.3vw] md:h-[360px] md:rounded-[28px] sm:h-[70vw] sm:rounded-[24px]">
                    <img
                        src="<?php echo get_template_directory_uri(); ?>/src/imgs/about/about-hero.png"
    ...
    <div class="">
        <canvas class="network-canvas-el absolute inset-0 h-full w-full" data-star-color="#E86224" data-line-color="#031022"></canvas>
</div>
