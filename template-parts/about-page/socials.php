...
<section class="about-socials-section px-[5vw] py-[7%] md:px-[7vw] md:py-16  sm:py-12">
    <div class="mb-[3.5vw] flex items-center gap-[0.8vw] md:mb-8 md:gap-3 sm:mb-12" data-animate="fade-up">
    ...
    <div class="rounded-[2vw] bg-brand-tint p-[4vw] md:rounded-3xl md:p-10 sm:rounded-xl" data-animate="fade-up">
        <div class="grid grid-cols-3 gap-[1.2vw] md:grid-cols-1 md:gap-5 sm:gap-8">
            <?php foreach ($instagram_posts as $index => $post): ?>
                ...
                >
                    ...
                    <span class="absolute bottom-[1vw] right-[1vw] flex h-[2vw] w-[2vw] items-center justify-center rounded-full bg-white md:bottom-4 md:right-4 md:h-10 md:w-10 sm:bottom-3 sm:right-3 sm:h-9 sm:w-9">
                        <img
