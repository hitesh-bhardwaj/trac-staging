    ...
    <div class="w-full px-[5.21vw] md:px-[4vw] sm:px-[6vw]">
        <div class="max-w-[92rem] mx-auto ">
            <div class="text-center max-w-[56rem] mx-auto">
                ...
                <h2 class="font-heading text-66 font-normal leading-[1.24] tracking-[0.01em] text-text-primary mb-[2.5vw] md:text-4xl md:mb-6 sm:text-3xl" data-heading-anim>
                    <?php echo esc_html($title); ?>
                </h2>

                <p class="font-body text-24 leading-[1.58] text-text-body mb-[1.3vw] md:text-lg md:mb-5 sm:text-base" data-para-anim data-delay="0.2">
                    <?php echo esc_html($p1); ?>
                </p>
                <p class="font-body text-24 leading-[1.58] text-text-body md:text-lg sm:text-base" data-para-anim data-delay="0.3">
