...
<section class="hero relative min-h-screen bg-white overflow-hidden" data-section="hero" data-hero-static>
    <div class="hero-container relative z-[10] w-full px-[5vw] pt-[12vw] pb-[5.21vw] md:px-[4vw] sm:px-[6vw] sm:pt-[16vw]">
        <div class="flex min-h-[calc(100vh-10vw)] items-center justify-center">
