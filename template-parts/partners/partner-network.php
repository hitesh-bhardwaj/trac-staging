...
<section class="partners-network relative bg-[#eef3fc] overflow-hidden" data-section="partners-network" data-partner-network>
    <div class="w-full px-[5.21vw] py-[7vw] md:px-[4vw] md:py-20 sm:px-[6vw] sm:py-16">
        <div class="max-w-[92rem] mx-auto text-center">
            ...
            <h2 class="font-heading text-[3.75vw] font-normal leading-[1.12] tracking-[0.01em] text-[#111] mb-[1.6vw] md:text-5xl md:mb-6 sm:text-4xl" data-animate="fade-up" data-delay="0.1">
                <?php echo esc_html($title); ?>
            </h2>

            <p class="font-body text-[1.25vw] leading-[1.5] text-[#1e1e1e] max-w-[52rem] mx-auto mb-[3.2vw] md:text-lg md:mb-10 sm:text-base sm:mb-8" data-animate="fade-up" data-delay="0.2">
            ...
            <div class="flex flex-wrap justify-center gap-4 md:gap-3 mb-[4.2vw] md:mb-10 sm:mb-8" role="tablist" aria-label="Partner categories" data-animate="fade-up" data-delay="0.25">
                <button type="button" class="partner-tab px-10 py-3 rounded-full border border-brand-primary text-text-primary font-body text-base transition-colors" data-partner-tab="all" role="tab" aria-selected="true">
                    All
                </button>
                <button type="button" class="partner-tab px-10 py-3 rounded-full border border-brand-primary/50 text-text-primary font-body text-base transition-colors hover:border-brand-primary" data-partner-tab="technology" role="tab" aria-selected="false">
                    Technology Partners
                </button>
                <button type="button" class="partner-tab px-10 py-3 rounded-full border border-brand-primary/50 text-text-primary font-body text-base transition-colors hover:border-brand-primary" data-partner-tab="reseller" role="tab" aria-selected="false">
                    Reseller Partners
                </button>
                <button type="button" class="partner-tab px-10 py-3 rounded-full border border-brand-primary/50 text-text-primary font-body text-base transition-colors hover:border-brand-primary" data-partner-tab="infrastructure" role="tab" aria-selected="false">
                    Infrastructure Partners
                </button>
            </div>

            <div class="grid grid-cols-4 gap-[1.6vw] md:grid-cols-2 md:gap-6 sm:gap-4" data-partner-logos>
                <?php foreach ($client_logos as $index => $logo):
                    $category = $categories[$index % count($categories)];
                    ?>
                    <div class="bg-white rounded-[1.6vw] md:rounded-2xl p-[2.4vw] md:p-7 sm:p-6 flex items-center justify-center aspect-[327/239]" data-partner-logo data-partner-category="<?php echo esc_attr(
                        $category,
