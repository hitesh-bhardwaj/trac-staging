...
/**
 * FAQ Accordion functionality with GSAP animations
 */
function initFaqAccordion() {
    ...
    faqItems.forEach((item) => {
        ...
        question.addEventListener('click', () => {
            ...
            faqItems.forEach((otherItem) => {
                if (
                    otherItem !== item &&
                    otherItem.classList.contains('is-active')
                ) {
                    const otherAnswer = otherItem.querySelector('.faq-answer');
                    const otherIconPlus =
                        otherItem.querySelector('.faq-icon-plus');
                    const otherIconMinus =
                        otherItem.querySelector('.faq-icon-minus');
                    ...
                    // Animate icons
                    gsap.to(otherIconPlus, {
                        opacity: 1,
                        rotation: 0,
                        duration: 0.3,
                        ease: 'power2.out',
                    });
                    gsap.to(otherIconMinus, {
                        opacity: 0,
                        rotation: -90,
                        duration: 0.3,
                        ease: 'power2.out',
            ...
            if (isActive) {
                ...
                // Animate icons - show plus, hide minus
                gsap.to(iconPlus, {
                    opacity: 1,
                    rotation: 0,
                    duration: 0.3,
                ...
                // Animate icons - hide plus, show minus
                gsap.to(iconPlus, {
                    opacity: 0,
                    rotation: 90,
                    duration: 0.3,
    ...
    console.log('[Trac] FAQ accordion initialized');
}
