...
// /products/sme-internet/) rather than the "Solutions" label -
   ...
   <nav
    ...
    <?php foreach ($solutions_menu_items as $solution_item): ?>
        <a href="<?php echo esc_url(
            $solution_item['url'],
        ); ?>" class="group w-[24%] h-[15vw] rounded-[0.8vw] bg-white border border-brand-primary pl-[1.5vw] p-[1vw] flex flex-col justify-center text-black hover:bg-brand-tertiary hover:border-brand-tertiary hover:text-white duration-300 ease-in-out">
